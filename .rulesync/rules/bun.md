...
> **Existing exception:** `apps/web` is a Vite-built TanStack Router SPA and stays that
> way — see `apps/web/docs/router.md`. This rule governs new Bun-served
> surfaces, not that app.

HTML files can import `.tsx`, `.jsx`, `.js`, and CSS directly:
