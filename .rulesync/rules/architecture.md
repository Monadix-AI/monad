...
- See `docs/internal/development/conventions.md` / @docs/internal/development/conventions.md.
...
- See `docs/internal/development/conventions.md` / @docs/internal/development/conventions.md and
...
- See `docs/internals/infra/runtime.md` / @docs/internals/infra/runtime.md,
  `docs/internal/development/security-guidelines.md` / @docs/internal/development/security-guidelines.md, and
  `docs/internal/development/performance-guidelines.md` / @docs/internal/development/performance-guidelines.md.
...
- Client code never imports daemon implementation or `@monad/environment` internals.
...
- Stream generation over per-session SSE and lifecycle over control WS; never merge the
  two planes. See `docs/internals/infra/realtime-channels.md` / @docs/internals/infra/realtime-channels.md.
...
- `apps/cli` is a thin client. It starts/resolves the daemon, dispatches through
  ...
  machine output untranslated. CLI design: `docs/internal/development/cli-design.md` / @docs/internal/development/cli-design.md.
- `apps/web` is a daemon-control UI. Server state lives in the daemon and RTK cache;
  do not add business logic to React components. UI rules: `docs/internal/development/design/ui-guidelines.md`
  / @docs/internal/development/design/ui-guidelines.md, `docs/internal/development/design/ux-guidelines.md` /
  @docs/internal/development/design/ux-guidelines.md, and copy rules in `docs/internal/development/design/ux-writing-guidelines.md`
  / @docs/internal/development/design/ux-writing-guidelines.md.
...
- File-based kinds (`skill`, `mcp`, `locale`) bypass JS registration by design; do not
  route them through `register()`. Every other kind — `connector`, `channel`, `command`,
  `message-type`, `provider`, `hook`, `sandbox`, `agent-adapter`, `workplace-experience` —
  must be declared in the manifest before it can register.
- Channel adapters do platform I/O only; the daemon owns session/store/agent wiring.
- New channels must meet conformance. See `docs/internals/infra/channel-conformance.md` /
  @docs/internals/infra/channel-conformance.md, `docs/usage/skills.md` / @docs/usage/skills.md, and
  `docs/internals/infra/model-providers.md` / @docs/internals/infra/model-providers.md.
...
- No data layer imports: no protocol, environment, client, or daemon packages.
- App-specific composition belongs in `apps/web/src/components/`.
- See `docs/internal/development/design/ui-guidelines.md` / @docs/internal/development/design/ui-guidelines.md and
  `docs/internal/development/design-principles.md` / @docs/internal/development/design-principles.md.
