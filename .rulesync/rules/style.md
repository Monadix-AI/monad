...
Full rules: `docs/internal/development/conventions.md` / @docs/internal/development/conventions.md.
...
Typing rules: `docs/internal/development/conventions.md` / @docs/internal/development/conventions.md.
