...
export const command: CommandDef = {
  name: 'mcp',
  group: 'configure',
  synopsis: 'mcp <list|status|search|add|remove|enable|disable|authorize|reconnect> [name] [args…]',
  subcommands: ['list', 'status', 'search', 'add', 'remove', 'enable', 'disable', 'authorize', 'reconnect'],
  description: 'manage MCP servers (add a command, a remote url, or a prebuilt binary; list; remove; authorize)',
  descriptionKey: 'cli.cmd.mcp.desc',
