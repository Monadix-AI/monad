...
export const command: CommandDef = {
  ...
  flags: {
    follow: {
      type: 'boolean',
      alias: 'f',
      description: 'follow the log for new output',
      descriptionKey: 'cli.logs.flag.follow'
    },
    lines: {
      type: 'number',
      alias: 'n',
      description: 'number of trailing lines to show (default 200)',
      descriptionKey: 'cli.logs.flag.lines'
    }
  },
  async run({ flags }) {
