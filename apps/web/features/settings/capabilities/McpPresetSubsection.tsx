...
import { Check, CheckCircle2, Download, Globe, Loader2, Monitor, MonitorPlay, Settings2 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto flex items-center justify-between gap-2">
        ...
        <Settings2 className="size-3.5 shrink-0 text-muted-foreground/40" />
      </div>
    </Card>
  );
}
