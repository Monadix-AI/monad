...
import type { AgentActivityOverride } from './types';

import { useEffect, useRef, useState } from 'react';

import { nativeCliAgentFacingCommandPhase } from './project-projection';
 ...
 *  Extracted from useProject — this piece owns its own state/effects and only needs `liveTools`. */
