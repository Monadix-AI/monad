...
import type { Message, MessageAttachment, TypingIndicator } from '../types';

import { ArrowDown01Icon, Attachment01Icon, Download04Icon, EyeIcon, TerminalIcon } from '@hugeicons/core-free-icons';
...
function AttachmentChip({ attachment }: { attachment: MessageAttachment }): React.ReactElement {
  const t = useT();
