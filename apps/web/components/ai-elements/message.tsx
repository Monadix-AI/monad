...
const _MessageBranch = ({ defaultBranch = 0, onBranchChange, className, ...props }: MessageBranchProps) => {
...
const _MessageBranchSelector = ({ className, ...props }: MessageBranchSelectorProps) => {
