...
import { Brain, ChevronDown, ChevronRight, Cloud, HardDrive, Loader2, Plus, ShieldOff, Trash2 } from 'lucide-react';
...
export function MemorySettings(_props: Props) {
  const t = useT();
  ...
  // Poll while the panel is open to catch qdrant download/launch transitions in real time.
  const { data: status } = useGetMemoryStatusQuery(undefined, { pollingInterval: 2000 });
