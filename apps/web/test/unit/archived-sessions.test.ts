...
} from '../../src/features/shell/archived-sessions.ts';
...
test('archived sessions search title and project name', () => {
  expect(
    filterArchivedSessions(
      [
        { id: 'chat', title: 'Refactor chat', updatedAt: '2026-07-15T03:00:00.000Z' },
        { id: 'project', projectName: 'Runtime mesh', title: 'Auth notes', updatedAt: '2026-07-15T03:00:00.000Z' }
      ],
      'mesh'
    ).map((item) => item.id)
  ).toEqual(['project']);
