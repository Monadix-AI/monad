import type { Session, SessionAttentionState, SessionGenerationState, SessionId } from '@monad/protocol';
...
interface WorkspaceSidebarMeta {
  projectExperiences: Array<{ icon?: string; id: string; label: string }>;
