...
import { sidebarItemStateClass } from '#/features/shell/sidebar/nav-item';
import {
  daemonDisplayHost,
      ...
      >
        <div className="relative flex min-w-0 flex-1">
          <DropdownMenuTrigger asChild>
            <button
              className={cn(
                'flex min-w-0 flex-1 items-center gap-2.5 rounded-md px-2.5 py-2 text-left',
                sidebarItemStateClass({ active: showSettings || menuOpen })
              )}
