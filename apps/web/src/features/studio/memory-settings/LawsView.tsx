import type { LawView, OptionalMemoryScopeQuery } from '@monad/protocol';
...
export function LawsView({ scope }: { scope?: OptionalMemoryScopeQuery }) {
  const t = useT();
  const { data, isError, isLoading, isFetching, refetch } = useGetLawsQuery(scope);
