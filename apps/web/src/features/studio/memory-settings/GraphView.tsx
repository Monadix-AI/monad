...
export function GraphView({ scope }: { scope?: OptionalMemoryScopeQuery }) {
  const t = useT();
  const { data, isError, isLoading, refetch, isFetching } = useGetGraphQuery(scope);
