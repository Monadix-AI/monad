        ...
        <section className="flex flex-col gap-1">
          ...
          <div className="divide-y rounded-lg border px-3">
            ...
            <SwitchSetting
              checked={confine}
              className="py-2.5"
              description={t('web.studio.sandboxConfineHint')}
              onCheckedChange={setConfine}
              title={t('web.studio.sandboxConfine')}
            />
            <div className={rowClass}>
        ...
        <section className="flex flex-col gap-1">
          ...
          <div className="divide-y rounded-lg border px-3">
            <SwitchSetting
              ...
              className="py-2.5"
              description={t('web.studio.sandboxGlobalEnabledHint')}
              onCheckedChange={setGlobalEnabled}
              title={t('web.studio.sandboxGlobalEnabled')}
            />
            {globalEnabled && (
              <div className={rowClass}>
                <Label>{t('web.studio.sandboxMode')}</Label>
