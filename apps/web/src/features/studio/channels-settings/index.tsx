...
function PairingsPanel({ channelId, t }: { channelId: ChannelId; t: ReturnType<typeof useT> }) {
  ...
  const pairings = useMemo(
    () => channelPairingSelectors.selectAll(pairingData ?? { ids: [], entities: {} }),
    [pairingData]
  );
      ...
      {open ? (
        <div className="flex flex-col gap-3 border-t px-3 py-3">
          <div className="flex items-center gap-2">
            ...
            >
              <HugeiconsIcon icon={PowerIcon} /> {channel.enabled ? t('web.ch.enabled') : t('web.ch.disabled')}
            </Button>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                size="sm"
              >
                <HugeiconsIcon icon={Key01Icon} /> {t('web.save')}
              </Button>
            </div>
          </div>
          ...
          <Button
            ...
            variant="outline"
          >
            <HugeiconsIcon icon={CheckIcon} /> {t('web.ch.saveSettings')}
          </Button>
          ...
          <div className="flex items-center gap-2 border-t pt-2">
            {confirmRemove ? (
              ...
              <Button
                ...
                variant="ghost"
              >
                <HugeiconsIcon icon={Delete02Icon} /> {t('web.ch.remove')}
              </Button>
            )}
          </div>
        </div>
