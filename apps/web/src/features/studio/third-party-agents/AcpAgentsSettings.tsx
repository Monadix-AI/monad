...
import { Badge, Button, Confirm, Input, Label, MorphChevron } from '@monad/ui';
  ...
  return (
    <div className="rounded-md border">
      ...
      <Confirm
        ...
        confirmLabel={t('web.acp.remove')}
        confirmVariant="destructive"
        description={t('web.acp.confirmRemoveDescription', { name: agent.name })}
        ...
        open={confirmRemove}
        pending={busy}
        pendingLabel={t('web.acp.removing')}
        title={t('web.acp.confirmRemove')}
      />
    </div>
  );
}
  ...
  return (
    <div className={wrapper}>
      ...
      <SwitchSetting
        ...
        description={t('web.acp.forwardMcpHint')}
        id={forwardMcpId}
        onCheckedChange={setForwardMcp}
        title={t('web.acp.forwardMcp')}
      />
