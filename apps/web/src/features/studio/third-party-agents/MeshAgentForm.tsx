...
import {
  argsToStr,
  envToStr,
  meshAgentReasoningEffortsForModel,
  modelOptionsToStr,
...
export function AgentForm({
  ...
  return (
    <div className={wrapper}>
      ...
      {mode === 'create' ? (
        <div className="flex flex-col gap-1">
          <Label className="text-xs">{t('web.meshAgent.autopilot')}</Label>
          <div className="flex items-center gap-2">
            <Switch
              aria-label={t('web.meshAgent.autopilot')}
          ...
          <p className="text-[11px] text-muted-foreground">{t('web.meshAgent.autopilotHint')}</p>
        </div>
      ) : null}
      {showAdvanced ? (
...
function ProjectTemplatesEditor({
  ...
  const t = useT();
  const updateTemplate = (index: number, patch: Partial<MeshAgentProjectTemplate>) => {
  ...
  const effortsForModel = (modelId: string | undefined) => {
    return meshAgentReasoningEffortsForModel(reasoningEfforts, reasoningEffortsByModel, modelId);
  };
    ...
    <div className="flex flex-col gap-2 rounded-md border bg-muted/20 p-3">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <Label className="text-xs">{t('web.meshAgent.projectTemplates')}</Label>
          <p className="mt-1 text-[11px] text-muted-foreground">{t('web.meshAgent.projectTemplatesHint')}</p>
        </div>
        <Button
          onClick={addTemplate}
          size="sm"
        ...
        return (
          ...
          >
            <div className="grid gap-2 sm:grid-cols-2">
              <div className="flex flex-col gap-1">
                <Label className="text-xs">{t('web.meshAgent.projectTemplateId')}</Label>
                <Input
              ...
              <div className="flex flex-col gap-1">
                <Label className="text-xs">{t('web.meshAgent.projectTemplateDisplayName')}</Label>
                <Input
            ...
            <div className="grid gap-2 sm:grid-cols-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  onValueChange={(value) =>
                    updateTemplate(index, {
                      speed: (value === SELECT_EMPTY_VALUE ? undefined : value) as MeshAgentProjectTemplate['speed']
                    })
                  }
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value={SELECT_EMPTY_VALUE}>
                      {t('web.meshAgent.projectTemplateStandardSpeed')}
                    </SelectItem>
                    <SelectItem value="fast">{t('web.meshAgent.projectTemplateFastSpeed')}</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            <div className="flex flex-col gap-1">
              <Label className="text-xs">{t('web.meshAgent.projectTemplatePrompt')}</Label>
              <textarea
                ...
                placeholder={t('web.meshAgent.projectTemplatePromptPlaceholder')}
