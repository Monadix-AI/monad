    ...
    >
      <DialogContent size="lg">
        ...
        <DialogBody className="flex flex-col gap-4 pt-1">
          <button
            className="flex min-h-48 flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed bg-muted/20 px-6 py-10 text-center transition-[background-color,border-color] hover:bg-muted/35"
            disabled={loading}
