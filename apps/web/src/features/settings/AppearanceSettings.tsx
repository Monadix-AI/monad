        ...
        <ContentColumn>
          ...
          <section className="flex flex-col gap-3">
            ...
            <div className="grouped-list">
              ...
              <div className="grouped-list-row px-2 py-2">
          ...
          <section className="flex flex-col gap-3">
            ...
            <div className="grouped-list">
              <div className="grouped-list-row grid gap-4 sm:grid-cols-[minmax(0,1fr)_minmax(260px,480px)] sm:items-center">
          ...
          <section className="flex flex-col gap-3">
            ...
            <div className="grouped-list">
              <SwitchSetting
                ...
                description={t('web.settings.appearance.interactiveCursorDesc')}
                icon={<HugeiconsIcon icon={HandIcon} />}
                onCheckedChange={handleInteractiveCursor}
                title={t('web.settings.appearance.interactiveCursor')}
              />
            </div>
          </section>
        </ContentColumn>
