export type SettingsSectionId = 'connection' | 'profile' | 'experience' | 'licenses' | 'system';

const SETTINGS_SECTION_IDS = ['connection', 'profile', 'experience', 'licenses', 'system'] as const;
