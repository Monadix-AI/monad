...
import { initialInteractionValues, interactionProducerLabel, validateInteractionValues } from './model';
      ...
      >
        <DialogHeader>
          <p
            ...
            data-host-source
          >
            Requested by {interactionProducerLabel(active.interaction.source)}
          </p>
