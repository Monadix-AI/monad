...
import { ClarifyPrompt } from '#/features/session/SessionActionCards';
import { SessionApprovalSheet } from '#/features/session/SessionApprovalSheet';
...
export function ClarificationExample() {
  ...
  return (
    <div className="grid gap-2">
      <ClarifyPrompt
        onAnswer={(response) => setAnswer(response.answer ?? response.action ?? 'No answer yet.')}
