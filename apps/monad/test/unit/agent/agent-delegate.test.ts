...
const ROSTER: DelegatableAgent[] = [
  { name: 'researcher', atoms: { mode: 'inherit', allow: [], deny: [] } },
  {
    name: 'narrow',
...
test('built-in capabilities stay narrowed by an allowlist agent', async () => {
