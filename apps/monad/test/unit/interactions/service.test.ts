import type { InteractionPresenterCapabilities, InteractionProducer, InteractionRequest } from '@monad/protocol';

import { describe, expect, test } from 'bun:test';

import { redactInteractionRequest } from '#/interactions/redact';
import { HostInteractionError, InteractionService } from '#/interactions/service';

const source: InteractionProducer = {
  kind: 'atom-pack',
  packId: 'example.pack',
  atomId: 'configure'
};
