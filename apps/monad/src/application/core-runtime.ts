...
import { LOG_MAINTENANCE_MODULE_ID } from '#/services/log-maintenance/lifecycle.ts';
...
export function readCoreRuntimeOutputs(context: RuntimeContextReader): CoreRuntimeOutputs {
  return {
    ...
    capabilities: context.get<AgentCapabilityRuntime>('capabilities'),
    ...
    logMaintenance: context.get<LogMaintenanceService>(LOG_MAINTENANCE_MODULE_ID)
  };
}
