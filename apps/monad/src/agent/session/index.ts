...
import type { AgentId, OperationSource, Session, SessionId, SessionState } from '@monad/protocol';
...
export class SessionManager {
  ...
  async create(title: string, agentId?: AgentId, origin?: OperationSource, cwd?: string): Promise<Session> {
