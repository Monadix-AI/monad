// Intentionally free of any @monad/environment dependency: the daemon reads its settings files and
...
export interface GatewayDeps {
  ...
  /** Report an attempt outcome so provider credential health/usage can be updated. */
