...
export class PromptBuilder {
  ...
  private credentialManifest(sessionId?: SessionId): string | undefined {
    return typeof this.deps.credentialManifest === 'function'
      ? this.deps.credentialManifest(sessionId)
      : this.deps.credentialManifest;
  }
