import type { InteractionField, InteractionProducer, InteractionRequest, PendingInteraction } from '@monad/protocol';
...
function projectSource(source: InteractionProducer): InteractionProducer {
