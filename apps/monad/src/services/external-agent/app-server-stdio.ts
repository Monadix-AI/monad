...
/**
 * Wrap the child's stdin pipe as the transport-neutral `ExternalAgentAppServerConnection` (the `stdio`
 ...
 */
export function connectAppServerStdio(pipe: AppServerStdioPipe | undefined): ExternalAgentAppServerConnection {
