...
/**
 * Wrap the child's stdin pipe as the transport-neutral `NativeCliAppServerConnection` (the `stdio`
 ...
 */
export function connectAppServerStdio(pipe: AppServerStdioPipe | undefined): NativeCliAppServerConnection {
