...
export interface NativeCliEventLogDeps {
  store: Store;
  bus: EventBus;
}

/** Builds and dispatches native-CLI session events, split by durability: `emit` persists a milestone
...
export class NativeCliEventLog {
  constructor(private readonly deps: NativeCliEventLogDeps) {}
