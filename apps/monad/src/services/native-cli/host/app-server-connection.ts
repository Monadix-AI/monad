...
export class NativeCliAppServerConnectionManager {
  constructor(private readonly ctx: NativeCliAppServerConnectionContext) {}
  ...
  private emitReconnectRequired(id: string, live: LiveNativeCliSession): void {
    this.ctx.emit(live.transcriptTargetId, 'native_cli.connection_required', {
