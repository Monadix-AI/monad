 ...
 * transport-neutral `MeshAgentAppServerConnection`. Text frames are delivered to `onMessage`; pings
 * are answered; a server close or socket drop fires `onClose`.
 */
export async function connectAppServerUnix(opts: ConnectAppServerUnixOptions): Promise<MeshAgentAppServerConnection> {
...
function handshake(opts: ConnectAppServerUnixOptions, deadline: number): Promise<MeshAgentAppServerConnection> {
  return new Promise<MeshAgentAppServerConnection>((resolve, reject) => {
