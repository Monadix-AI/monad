...
export const EVENT_PAGE_PROCESS_TIMEOUT_MS = 5_000;
export const MAX_STRUCTURED_LINE = 2 * 1024 * 1024;
export const EVENT_PAGE_TIMEOUT_MS = 5_000;
...
export const MESH_AGENT_IDLE_TIMEOUT_MS = 10 * 60_000;

export type MeshAgentOutputStream = 'stdout' | 'stderr' | 'pty';
