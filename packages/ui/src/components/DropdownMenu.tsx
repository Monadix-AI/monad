...
function DropdownMenuCheckboxItem({
  ...
  indicatorPosition?: 'end' | 'start';
}) {
  return (
    <DropdownMenuPrimitive.CheckboxItem
      checked={checked}
      className={cn(
        "relative flex select-none items-center gap-2 rounded-sm py-1.5 text-sm outline-hidden focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        indicatorPosition === 'start' ? 'pr-2 pl-8' : 'pr-8 pl-2',
        className
      )}
