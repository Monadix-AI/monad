...
const CodeBlockContainer = ({
  ...
  // No content-visibility here: these blocks render inside virtualized lists, which already
  // window rendering. An inner visibility gate lays the block out at the intrinsic-size guess
...
const _CodeBlockLanguageSelector = (props: CodeBlockLanguageSelectorProps) => <Select {...props} />;

type CodeBlockLanguageSelectorTriggerProps = ComponentProps<typeof SelectTrigger>;

const _CodeBlockLanguageSelectorTrigger = ({ className, ...props }: CodeBlockLanguageSelectorTriggerProps) => (
  <SelectTrigger
...
const _CodeBlockLanguageSelectorValue = (props: CodeBlockLanguageSelectorValueProps) => <SelectValue {...props} />;

type CodeBlockLanguageSelectorContentProps = ComponentProps<typeof SelectContent>;

const _CodeBlockLanguageSelectorContent = ({ align = 'end', ...props }: CodeBlockLanguageSelectorContentProps) => (
  <SelectContent
    align={align}
    {...props}
  />
...
const _CodeBlockLanguageSelectorItem = (props: CodeBlockLanguageSelectorItemProps) => <SelectItem {...props} />;
