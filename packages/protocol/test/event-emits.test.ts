...
// See docs/internals/infra/realtime-channels.md for why generation rides SSE rather than a WS RPC.
...
// sync with docs/internals/infra/realtime-channels.md (data-plane list) — a new generation event type belongs here.
