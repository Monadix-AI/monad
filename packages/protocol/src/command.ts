...
export const commandsListQuerySchema = z.object({
  filter: commandsListFilterSchema.optional(),
  sessionId: sessionIdSchema.optional()
});
export type CommandsListQuery = z.infer<typeof commandsListQuerySchema>;
export type CommandsListQueryInput = { filter?: CommandsListFilter; sessionId?: string };
