...
export const interactionProducerSchema = z.discriminatedUnion('kind', [
...
export type InteractionProducer = z.infer<typeof interactionProducerSchema>;

export const pendingInteractionSchema = z
  .object({
    id: z.string().min(1),
    source: interactionProducerSchema,
