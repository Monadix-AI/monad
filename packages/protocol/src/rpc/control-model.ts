...
// Self-contained view shapes for model settings (gateway), no dependency on @monad/environment. Secrets
// never cross this boundary: a CredentialView carries only configured state.
