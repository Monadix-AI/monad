...
import { nativeAgentTurnPointerSchema } from './external-agent-observation.ts';
...
export const externalAgentInboxDeliveryStateSchema = z.enum(['queued', 'delivered', 'visible', 'consumed']);
export type ExternalAgentInboxDeliveryState = z.infer<typeof externalAgentInboxDeliveryStateSchema>;
...
export const externalAgentInboxItemSchema = z.object({
