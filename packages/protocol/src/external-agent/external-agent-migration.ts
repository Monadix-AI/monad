...
import { externalAgentProviderSchema, externalAgentViewSchema } from './external-agent-config.ts';
...
export const externalAgentSettingsImportCandidateSchema = adapterMigrationCandidateSchema;
export type ExternalAgentSettingsImportCandidate = AdapterMigrationCandidate;
...
export const adapterMigrationItemSchema = z.object({
  ...
  agent: externalAgentViewSchema.optional(),
  payload: z.unknown().optional()
});
export type AdapterMigrationItem = z.infer<typeof adapterMigrationItemSchema>;
export const externalAgentSettingsImportItemSchema = adapterMigrationItemSchema;
export type ExternalAgentSettingsImportItem = AdapterMigrationItem;
...
export const externalAgentSettingsImportPreviewRequestSchema = adapterMigrationPreviewRequestSchema;
export type ExternalAgentSettingsImportPreviewRequest = AdapterMigrationPreviewRequest;
...
export const externalAgentSettingsImportPreviewSchema = adapterMigrationPreviewSchema;
export type ExternalAgentSettingsImportPreview = AdapterMigrationPreview;

export const listExternalAgentSettingsImportCandidatesResponseSchema = z.object({
  candidates: z.array(adapterMigrationCandidateSchema)
});
export type ListExternalAgentSettingsImportCandidatesResponse = z.infer<
  typeof listExternalAgentSettingsImportCandidatesResponseSchema
>;
...
export const externalAgentSettingsImportApplyRequestSchema = adapterMigrationApplyRequestSchema;
export type ExternalAgentSettingsImportApplyRequest = AdapterMigrationApplyRequest;
...
export const externalAgentSettingsImportApplyResultSchema = adapterMigrationApplyResultSchema;
export type ExternalAgentSettingsImportApplyResult = AdapterMigrationApplyResult;
