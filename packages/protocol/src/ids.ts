...
export const PROJECT_MEMBER_ID_MAX_LENGTH = 512;
export const projectMemberIdSchema: z.ZodType<ProjectMemberId> = z.string().min(1).max(PROJECT_MEMBER_ID_MAX_LENGTH);
