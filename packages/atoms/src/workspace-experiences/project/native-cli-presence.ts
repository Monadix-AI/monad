...
import { nativeCliStreamItems } from './native-cli-observation/native-cli-observation.ts';

export type WorkspaceExperiencePresence = 'online' | 'working' | 'needs-login' | 'failed' | 'stopped' | 'idle';
export type WorkspaceExperienceAgentActivityPhase = 'reading' | 'thinking' | 'speaking';
