...
import { toWorkplaceExperienceGraphCanvas } from './experience/activity-graph.ts';
...
export type ProjectWorkdirController = WorkplaceExperienceWorkdir;
export type ProjectExperienceSnapshot = WorkplaceExperienceSnapshot;
export type ProjectExperienceActions = WorkplaceExperienceActions;
...
export interface WorkplaceExperienceRuntimeViews {
  'chat-room': ChatRoomExperienceRuntime;
}

export interface ProjectExperienceRuntime {
  views: WorkplaceExperienceRuntimeViews;
...
export function createProjectExperienceRuntime(
  ...
  const snapshot: ProjectExperienceSnapshot = {
    ...
    graphCanvas: toWorkplaceExperienceGraphCanvas({
