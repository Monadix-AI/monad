...
function monadMcpFields(view: MonadMcpToolView, t: ReturnType<typeof workplaceExperienceT>): React.ReactNode {
...
function monadMcpTarget(view: MonadMcpToolView, t: ReturnType<typeof workplaceExperienceT>): string {
...
function monadMcpBoolean(value: boolean, t: ReturnType<typeof workplaceExperienceT>): string {
