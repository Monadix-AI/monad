...
export const PROVIDER_DESCRIPTORS = {
  ...
  'vercel-gateway': {
    ...
    icon: providerIcons['vercel-gateway'],
    strategy: 'native',
  ...
  'amazon-bedrock': {
    ...
    icon: providerIcons['amazon-bedrock'],
    strategy: 'native',
  ...
  'cloudflare-gateway': {
    ...
    label: 'Cloudflare',
    icon: providerIcons['cloudflare-gateway'],
    strategy: 'openai-compatible',
    needsUrl: true,
    keyPlaceholder: GENERIC_KEY_PLACEHOLDER
  },
