import {
  ...
  type MeshRawEventPage,
  type MeshRawEventRecord,
...
export const observationFixtureSchema = z
  .object({
    ...
    page: meshRawEventPageSchema
  })
  .strict();
export type ObservationFixture = z.infer<typeof observationFixtureSchema>;

export const multiTurnObservationFixtureSchema = z
  .object({
    provider: meshAgentProviderSchema,
    turns: z
      .array(meshRawEventPageSchema.omit({ nextCursor: true }).strict())
      .min(4)
      .max(8)
  })
  .strict();
export type MultiTurnObservationFixture = z.infer<typeof multiTurnObservationFixtureSchema>;
