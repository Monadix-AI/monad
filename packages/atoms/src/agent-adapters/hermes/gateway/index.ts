...
// dial URL's query string (see hermes/index.ts's `gatewayWs.query`).
...
export const hermesGatewayHooks: GatewayCliHooks = {
  initialize: hermesInitialize,
  parseGatewayOutput: parseHermesOutput,
  sendGatewayInput: sendHermesInput,
  resolveGatewayApproval: resolveHermesApproval
};
