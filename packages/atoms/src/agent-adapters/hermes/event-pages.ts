import type { MeshAgentProviderEventPageContext, MeshAgentProviderEventPageRequestContext } from '@monad/sdk-atom';
...
export async function hermesEventPage(
  ...
  return { ...page, [EVENT_SOURCE]: loaded.source } as MeshAgentProviderEventPageContext['page'];
}
