...
// (schema-first at the runtime boundary; see docs/internal/development/conventions.md §3).
...
export interface QwenStreamJsonContext {
  stdin?: QwenStdin;
}
...
export function parseQwenStreamJson(chunk: string, context?: QwenStreamJsonContext): MeshAgentOutputEvent[] {
