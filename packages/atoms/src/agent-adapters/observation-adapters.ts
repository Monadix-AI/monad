...
export type MeshAgentObservationAdapterEntry = Pick<MeshAgentProviderAdapter, 'observation' | 'provider'>;
...
export const builtinMeshAgentObservationAdapters: MeshAgentObservationAdapterEntry[] = [
