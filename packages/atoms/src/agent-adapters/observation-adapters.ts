...
export type NativeCliObservationAdapterEntry = Pick<NativeCliProviderAdapter, 'observation' | 'provider'>;
...
export const builtinNativeCliObservationAdapters: NativeCliObservationAdapterEntry[] = [
