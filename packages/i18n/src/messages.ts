...
export const enMessages = mergeCatalogs([enChannel, enCli, enCmd, enDaemon, enInit, enWeb]);
export const zhMessages = mergeCatalogs([zhChannel, zhCli, zhCmd, zhDaemon, zhInit, zhWeb]);
