import type { SessionId, SessionMemberBinding, SpawnSessionMemberRequest } from '@monad/protocol';
...
const spawnSessionMemberApi = apiSlice.injectEndpoints({
  ...
  endpoints: (builder) => ({
    spawnSessionMember: builder.mutation<SessionMemberBinding, { sessionId: SessionId } & SpawnSessionMemberRequest>({
      ...
      // Also mints a canonical ProjectMember — the project-wide roster needs to see it.
