...
describe('readDenyRoots', () => {
  ...
  // bug reappears here.
  test(
    'a readDenyRoot NESTED inside a writableRoot is still shadowed — its deny ' +
  ...
  test(
    'readableRoots variant: a readDenyRoot nested inside a --ro-bind readableRoot ' + 'is still shadowed after it',
    () => {
