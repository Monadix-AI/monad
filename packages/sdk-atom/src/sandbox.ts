...
// confines the child — Seatbelt, Landlock, Low-Integrity, or a future cloud backend (e2b) —
...
//              for a later phase; the contract carries it so adding a cloud backend needs no
//              re-architecture.
 ...
 *  so a cloud backend can satisfy it without importing the daemon's runtime. */
