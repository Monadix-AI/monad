---
title: "Context Management (The Gentle Cascade)"
description: "Manage long Agent sessions through observable eviction, recoverable handles, and bounded summarization."
---
...
`agents.json` and hot-reloads on save (no restart).
...
([context/index.ts](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/agent/context/index.ts)): it prefers the
...
([loop/tool-output.ts](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/agent/loop/tool-output.ts)) caps a
...
**Store semantics** ([store/db/index.ts](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/store/db/index.ts)):
...
- Cleaned up on session/project delete and on `session reset` (cascade in
  [store/db/sessions.ts](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/store/db/sessions.ts)).
...
`DurableSummarizer` ([history.ts](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/agent/history.ts)) is the
...
([context/recitation.ts](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/agent/context/recitation.ts)) pulls
...
([context/retrieval.ts](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/agent/context/retrieval.ts)) embeds the
...
([services/memory/index.ts](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/services/memory/index.ts)), a
...
tool ([memory.md](/internals/agent-runtime/memory)) — no weaker validation on the auto path. Best-effort:
a failed extraction never affects the turn.

## Telemetry and UX

Four wire events surface what the cascade did (all data-plane, over per-session
SSE — see [realtime-channels.md](/internals/infra/realtime-channels)):
...
[handlers/session/context.ts](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/handlers/session/context.ts)
