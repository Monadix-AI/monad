...
The provider catalog in [`packages/atoms/src/providers/catalog.ts`](../../packages/atoms/src/providers/catalog.ts)
...
- **`native`** — a dedicated AI SDK package, one provider module in
  [`packages/atoms/src/providers/`](../../packages/atoms/src/providers).
...
- OpenAI-compatible endpoint → add one `ModelProviderType` enum member + one
  ...
  [`apps/web/src/lib/ProviderMeta.tsx`](../../apps/web/src/lib/ProviderMeta.tsx).
