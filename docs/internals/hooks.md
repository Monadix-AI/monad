...
- Behaviour is identical over both transports; coverage in
  ...
  [`apps/monad/test/unit/hooks/hooks-runner.test.ts`](../../apps/monad/test/unit/hooks/hooks-runner.test.ts),
  and [`apps/monad/test/unit/agent/loop-hooks.test.ts`](../../apps/monad/test/unit/agent/loop-hooks.test.ts).
```
