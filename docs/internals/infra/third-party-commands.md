---
title: "Third-Party Slash Commands"
description: "Atom packs can contribute slash commands with defineCommand() from @monad/sdk-atom. Commands are host-run actions: the daemon owns parsing, permission."
---
...
Two fields the example above omits: `descriptionKey` (an i18n message id — the localized text
