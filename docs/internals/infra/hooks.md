...
description: "Observe and steer Agent lifecycle events with manifest-gated hooks for context, model calls, tools, and persistence."
---
...
- **Command hooks** — shell commands, configured in `agents.json`. The daemon spawns the
...
[`packages/protocol/src/hooks.ts`](https://github.com/Monadix-AI/monad/blob/main/packages/protocol/src/hooks.ts) (contract),
[`apps/monad/src/hooks/runner.ts`](https://github.com/Monadix-AI/monad/blob/main/apps/monad/src/hooks/runner.ts)
(dispatch), [`packages/environment/src/config/index.ts`](https://github.com/Monadix-AI/monad/blob/main/packages/environment/src/config/index.ts) (`hooks` +
`policyHooks`), [`packages/sdk-atom/src/hook.ts`](https://github.com/Monadix-AI/monad/blob/main/packages/sdk-atom/src/hook.ts) (SDK).
...
| `AfterModel` | after a **successful** reasoning response | no | rewrite the response (`mutatedText`) | serial |
...
```ts
caller: { kind: 'main' | 'subagent', agentName?: string }
```
...
- Behaviour is identical over both transports; coverage in
  [`apps/monad/test/e2e/hooks.test.ts`](https://github.com/Monadix-AI/monad/blob/main/apps/monad/test/e2e/hooks.test.ts),
  [`apps/monad/test/unit/hooks/hooks-runner.test.ts`](https://github.com/Monadix-AI/monad/blob/main/apps/monad/test/unit/hooks/hooks-runner.test.ts),
  and [`apps/monad/test/unit/agent/loop-hooks.test.ts`](https://github.com/Monadix-AI/monad/blob/main/apps/monad/test/unit/agent/loop-hooks.test.ts).
```text
