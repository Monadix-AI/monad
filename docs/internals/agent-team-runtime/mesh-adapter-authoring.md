---
title: "Author a Third-Party Agent Adapter"
description: "A third-party agent provider adapter translates one provider's launch, control, authentication, and event semantics into Monad's shared contracts. The daemon owns."
---
A third-party agent provider adapter translates one provider's launch, control, authentication,
